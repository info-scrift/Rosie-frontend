  ...
  const Register = () => {
    ...
    const initialTab: "user" | "company" = formParam === "company" ? "company" : "user";
    const [activeTab, setActiveTab] = useState<"user" | "company">(initialTab);  const [showPassword, setShowPassword] = useState(false)
    ...
    return (
      <div className="w-full max-w-2xl mx-auto">
        ...
        onValueChange={(v) => setActiveTab(v as "user" | "company")}
        className="w-full">
